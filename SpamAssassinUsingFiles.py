...
def get_data(path, label):
    ...
    print(f"Number of {(label)} emails read: {len(data)}")
    return data
...
class email_data_extraction:
    ...
    # Extract key information into csv file
...
# Get email data
easy_ham = get_data(easy_ham_path, "Easy Ham")
hard_ham = get_data(hard_ham_path, "Hard Ham")
...
# Run the process to extract cleaned text
