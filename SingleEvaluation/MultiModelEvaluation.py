...
def main():
    ...
    TestEmail = os.path.join(base_dir, "SingleEvaluation", "Test Emails", "TestEmail.eml")
    ...
    results = []
    for model_file in os.listdir(TestModel):
        model_path = os.path.join(TestModel, model_file)
