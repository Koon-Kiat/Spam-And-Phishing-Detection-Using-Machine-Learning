    ...
    try:
        ...
        for fold_idx, (X_train, X_test, y_train, y_test) in enumerate(folds, start=1):
            ...
            model_path = os.path.join(
                base_dir, base_dir, 'model_training', 'stacked_models', f'XGB_RF_LG_Fold_{fold_idx}.pkl')
            params_path = os.path.join(base_dir, base_dir, 'model_training', 'stacked_models',
