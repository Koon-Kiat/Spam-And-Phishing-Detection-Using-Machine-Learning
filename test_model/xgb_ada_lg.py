...
def main():
    ...
    try:
        ...
        for fold_idx, (X_train, X_test, y_train, y_test) in enumerate(folds, start=1):
            ...
            model_path = os.path.join(base_dir, 'Test Models', 'Stacked Models (Optuna)', f'XGB_ADA_LG_Fold_{fold_idx}.pkl')
            params_path = os.path.join(base_dir, 'Test Models', 'Stacked Models (Optuna)', f'XGB_ADA_LG_Best_Params_Fold_{fold_idx}.json')
