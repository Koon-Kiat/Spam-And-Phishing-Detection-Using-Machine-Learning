...
def main():
    ...
    PreprocessedEvaluationDataset = os.path.join(
        base_dir, 'Dataset Evaluation', 'Data Preprocessing', 'Preprocessed_Evaluation_Dataset.csv')
    ExtractedEvaluationHeaderFile = os.path.join(
        base_dir, 'Dataset Evaluation', 'Feature Engineering', 'Extracted_Evaluation_HeaderFile.csv')
    CleanedEvaluationDataFrame = os.path.join(
        base_dir, 'Dataset Evaluation', 'Data Cleaning', 'Cleaned_Evaluation_DataFrame.csv')
    MergedEvaluationFile = os.path.join(
        base_dir, 'Dataset Evaluation', 'Data Integration', 'Merged_Evaluation.csv')
    MergedCleanedDataFrame = os.path.join(
        base_dir, 'Dataset Evaluation', 'Data Cleaning', 'Merged_Cleaned_DataFrame.csv')
    ...
    processor_evaluation = DatasetProcessor(
        df_evaluation, "text", "Evaluation Dataset", PreprocessedEvaluationDataset)
    ...
    evaluation_email_headers = load_or_extract_headers(
        df_processed_evaluation, ExtractedEvaluationHeaderFile, EmailHeaderExtractor, 'Evaluation')
    logging.info(
    ...
    df_evaluation_clean = load_or_clean_data(
        "Evaluation", merged_evaluation, 'body', CleanedEvaluationDataFrame, data_cleaning)
    ...
    if not merged_evaluation_label_counts.equals(df_evaluation_clean_combined_counts):
        ...
        df_evaluation_clean_combined.to_csv(
            MergedCleanedDataFrame, index=False)
        logging.info(f"Data Cleaning completed.\n")
    ...
    data_dir = os.path.join(
        base_dir, 'Dataset Evaluation', 'Feature Extraction')
    ...
    model_folders = [Main_Model, Base_Model_No_Optuna,
    ...
    output_path = os.path.join(
        'Dataset Evaluation', 'Model_Evaluation_Result.csv')
